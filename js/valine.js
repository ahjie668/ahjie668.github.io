  ...
  return function (e) {
    ...
    function (e, t, n) {
      ...
      t.DEFAULT_EMOJI_CDN = "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/",
        ...
        t.defaultConfig = {
          lang: "zh-CN",
          langMode: null,
          appId: "84Gj3MSVSWbUFORCRIOFMVrm-gzGzoHsz",
          appKey: "fVRKgsPJxPKQRNw94COJOHLI",
          clazzName: "Comment",
          meta: ["nick", "mail", "link"],
    ...
    function (e, t, n) {
      ...
      ! function (n, a) {
        ...
        function n(e) {
          ...
          function o() {
            r();
            var b = Math.round(parseFloat(e.style.height)),
              n = window.getComputedStyle(e, null),
              o = "content-box" === n.boxSizing ? Math.round(parseFloat(n.height)) : s.offsetHeight;
            if (o < b ? "hidden" === n.overflowY && (t("scroll"),
                r(),
                o = "content-box" === n.boxSizing ? Math.round(parseFloat(window.getComputedStyle(s, null).height)) : s.offsetHeight) : "hidden" !== n.overflowY && (t("hidden"),
                r(),
                o = "content-box" === n.boxSizing ? Math.round(parseFloat(window.getComputedStyle(s, null).height)) : s.offsetHeight),
              c !== o) {
              c = o;
        ...
        o.prototype.bind = function () {
          ...
          var C = function (t, n, r) {
              ...
              var l = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : "",
                ...
                d = u + '<div class="vh"><div class="vhead">' + c + (e.config.masters.includes(t.get("mail")) && e.config.masterTag ?'<span class="vtag vmaster">' + e.config.masterTag + '</span>':"") + " " + a + '</div><div class="vmeta"><span class="vtime" >' + (0,
                  g.default)(t.get("insertedAt"), e.i18n) + '</span><span class="vat" data-vm-id="' + (t.get("rid") || t.id) + '" data-self-id="' + t.id + '">' + e.i18n.t("reply") + '</span></div><div class="vcontent md" data-expand="' + e.i18n.t("expand") + '">' + (0,
          ...
          var changeTips = function(tip, show) {
            e.$el.find(".status-bar")
            .html("" + show===true?tip:e.i18n.t(tip)).addClass("warning")
            .empty(3e3, e.config.tips);
          },
          z = e.$el.find(".vsubmit"),
          L = function (t) {
            if (e.config.requiredFields.indexOf("nick") > -1 && E.nick.length < 3)
              return v.nick[0].focus(),
                void changeTips("nickFail");
            if (e.config.requiredFields.indexOf("mail") > -1 && !/[\w-\.]+@([\w-]+\.)+[a-z]{2,3}/.test(E.mail))
              return v.mail[0].focus(),
                void changeTips("mailFail");
            if ("" == j)
          ...
          var B = function (e, t) {
            ...
            N = function D(t, n) {
              ...
              if (r > 0) {
                ...
                var a = "![Uploading " + o.name + "...]()";
                x(i[0], a),
                  Q(o, function (s) {
                    500 != s.code ? (i.val(i.val().replace(a, "![" + o.name + "](" + s.data.url + ")\r\n")),
                      (0,
                        c.default)(i[0]),
                      ++n < r ? D(t, n) : z.removeAttr("disabled")) : (i.val(i.val().replace(a, "")),
                      (0,
                        c.default)(i[0]),
                      changeTips(s.msg, true),
                      z.removeAttr("disabled"))
                  })
              }
            },
    ...
    function (e, t, n) {
      ...
      var r = function (e, t) {
        ...
        i = function s(e) {
          return e instanceof Date ? e : !isNaN(e) || /^\d+$/.test(e) ? new Date(parseInt(e)) : /GMT/.test(e || "") ? s(new Date(e).getTime()) : (e = (e || "").replace(/(^\s*)|(\s*$)/g, "").replace(/\.\d+/, "").replace(/-/, "/").replace(/-/, "/").replace(/(\d)T(\d)/, "$1 $2").replace(/Z/, " UTC").replace(/([+-]\d\d):?(\d\d)/, " $1$2"),
            new Date(e))
        },
        a = function (e, t) {
        ...
        var i = function (e, t, n) {
          function r(o, i, a) {
            return a = Object.create(r.fn),
              o && a.push.apply(a, o[t] ? [o] : "" + o === o ? /</.test(o) ? ((i = e.createElement(i)).innerHTML = o,
    ...
    function (e, t) {
      e.exports = {
        ...
        link: "请输入网址网址(http://)",
        required: "(Required)",
        nickFail: "呢称不能不少于三个字节",
        mailFail: "请确认您的电子邮箱地址",
        sofa: "还没有评论",
        submit: "提交",
        reply: "回复",
        cancelReply: "取消回复",
