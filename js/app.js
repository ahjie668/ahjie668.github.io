var CONFIG = {"hostname":"ahjie668.github.io","root":"/","statics":"/","favicon":{"normal":"images/favicon.ico","hidden":"images/failure.ico"},"js":{"valine":"js/valine.js","chart":"npm/frappe-charts@1.5.0/dist/frappe-charts.min.iife.min.js","copy_tex":"npm/katex@0/dist/contrib/copy-tex.min.js","mediumzoom":"npm/medium-zoom@1.0.5/dist/medium-zoom.min.js"},"css":{"valine":"css/comment.css","katex":"npm/katex@0/dist/katex.min.css","mermaid":"css/mermaid.css"},"search":null,"quicklink":{"timeout":3000,"priority":true},"audio":["1471064193 || 隔岸（DJ完整版）","3932159 || You","1411358329 || 勇气","574566207 || 盗将行","1435449062 || 收敛","1442508316 || 丢了你","1436709403 || 夏天的风","1331819951 || 像鱼","254359 || 和你一样","26305534 || 曹操","424060342 || 花降らし"]};
...
const menuActive = function () {
  $.each('.menu .item', function (element) {
    ...
    element.parentNode.parentNode.classList.toggle('expand', element.parentNode.classList.contains('sub') && element.parentNode.querySelector('.active'));
  });
}
...
const postBeauty = function () {
  ...
  $.each('div.tab', function(element, index) {
    ...
    li.addEventListener('click', function(event) {
      var target = event.currentTarget;
      box.querySelectorAll('.active').forEach(function(el) {
